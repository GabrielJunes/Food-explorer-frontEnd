...
export function Edit({isAdmin}){
    ...
    async function handleEditDish(){
        if(!image){
            return alert("Você deve selecionar a imagem do prato.");
        }
        ...
        if (!category){
            return alert("informe a qual categoria o prato pertence");
        }
        ...
        if(newTag){
            return alert("Você deixou um ingrediente no campo para adicionar, porém não clicou em adicionar. Clique para adicionar ou deixe o campo vazio.")
        }
        ...
        if(confirm){
            ...
            try{
                ...
                if(error.response){
                    ...
                    alert("Não foi possível excluír o prato.")
                }
            }finally{
                setLoading(false);
            }
