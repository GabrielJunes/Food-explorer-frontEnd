...
export function New({isAdmin}){
    ...
    async function handleNewDish(){
        ...
        if(tags.length === 0){
            return alert("Informe no mínimo um ingrediente do prato.")
        }
        ...
        if(!description){
            return alert("Digite uma breve descrição do prato.")
        }
            ...
            <main>
                <Form>
                        ...
                        <Section title="Imagem do prato">
                            <Image className="Image">
                                <label htmlFor="image">
                                    ...
                                    <span>{fileName || "Selecione a imagem"}</span>
                    ...
                    <Section title="Descrição">
                        <Textarea
                            placeholder="Faça uma breve descrição do prato, seus ingredientes e composição."
